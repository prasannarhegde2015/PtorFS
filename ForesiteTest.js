...
describe('Well Configuration || Workflow Suite', function () {
	...
	it('Create RRL well', function () {
		...
		// Navigate to ForeSite Server:
		browser.get('http://pg009a25:8000');
		...
		findbyid(PageObject.WellConfigPage.wellnameinput).sendKeys("RPOC_00001");
		...
		var av = element(by.xpath("//li[text()='CYGNET.UIS']"));
		waitclick(av);
		...
		waitforload();
		var table = element(by.xpath("//table/tbody/tr/td[text()='RPOC_00001']"));
		waitclick(table);
		...
		//Input Well Commision Date
		comdate.sendKeys("04042016");
		...
		waitclick(dop);
		browser.sleep(1000);
		waitclick(element(by.xpath("//kendo-numerictextbox[@id='latitude']/descendant::input[1]")));
		browser.sleep(1000);
        cleartext(element(by.xpath("//kendo-numerictextbox[@id='latitude']/descendant::input[1]")));
		sendtext(element(by.xpath("//kendo-numerictextbox[@id='latitude']/descendant::input[1]")),'19.1258');
		sendtext(element(by.xpath("//kendo-numerictextbox[@id='longitude']/descendant::input[1]")),'70.1258');
       ...
       // Input Surface Parameters 
		...
		//Select 'Lufkin' from Manufacturer
		waitclick(element(by.xpath("//td[text()='Lufkin']")));
		waitforload();
		//Select 'C' from Type
		waitclick(element(by.xpath("//td[text()='C']")));
		waitforload();

		///Select  Item
		waitclick(element(by.xpath("//a[text()='Item']/ancestor::th/child::*[1]/child::*[1]")));
		sendtext(element(by.xpath("(//kendo-dropdownlist/descendant::span[contains(text(),'Contains')])[1]//parent::*[1]/parent::*[1]/following-sibling::*")),'C912-365-168');
		waitclick(element(by.xpath("//button[text()='Filter']")));
		waitclick(element(by.xpath("//td[contains(text(),'C912-365-168')]")));
		waitclick(element(by.xpath("//button[text()='Apply']")));

		waitclick(element(by.xpath("//label[text()=' Wrist Pin ']/following-sibling::*[1]")));
		waitclick(element(by.xpath("//li[text()='3']")));
		sendtext(element(by.xpath("//kendo-numerictextbox[@id='motorAmpsUp']/descendant::input[1]")),'144');
		sendtext(element(by.xpath("//kendo-numerictextbox[@id='motorAmpsDown']/descendant::input[1]")),'120');
		

		//******************Weights Tab  *********************************************************
		waitclick(element(by.xpath("//div[text()=' Weights ']")));
		waitclick(element(by.xpath("//label[text()=' Crank Id ']/following-sibling::*")));
		waitclick(element(by.xpath("//li[text()='9411OC']")));
		waitclick(element(by.xpath("//span[text()='Calculate']")));
		
		//Downhole Tab
		waitclick(element(by.xpath("//div[text()=' Downhole ']")));
		waitclick(element(by.xpath("(//kendo-dropdownlist[@id='pumpDiameter']/span/span)[1]")));
	
		waitclick(element(by.xpath("//li[text()='2.5']")));
		waitclick(element(by.xpath("//kendo-numerictextbox[@id='PumpDepth']//input")));
		cleartext(element(by.xpath("//kendo-numerictextbox[@id='PumpDepth']//input")));
		sendtext(element(by.xpath("//kendo-numerictextbox[@id='PumpDepth']//input")), "5081");
		sendtext(element(by.xpath("//kendo-numerictextbox[@id='TubingOD']//input")), "2.875");
		sendtext(element(by.xpath("//kendo-numerictextbox[@id='TubingID']//input")), "2.750");
		...
		sendtext(element(by.xpath("//kendo-numerictextbox[@id='TopPerforation']//input")), "4558");
		sendtext(element(by.xpath("//kendo-numerictextbox[@id='BottomPerforation']//input")), "5220");
		 //Adding Rods 
		 //Add Rod 1 
		...
		waitclick(element(by.xpath("//li[text()='Weatherford, Inc.']")));
		waitclick(element(by.xpath("(//table/tbody/tr/td)[4]/kendo-dropdownlist")));
		waitclick(element(by.xpath("//li[text()='D']")));
		waitclick(element(by.xpath("(//table/tbody/tr/td)[5]/kendo-dropdownlist")));
		waitclick(element(by.xpath("//li[text()='1']")));
		cleartext(element(by.xpath("(//table/tbody/tr/td)[6]/kendo-numerictextbox//input")));
		sendtext(element(by.xpath("(//table/tbody/tr/td)[6]/kendo-numerictextbox//input")), "30");
		sendtext(element(by.xpath("(//table/tbody/tr/td)[7]/kendo-numerictextbox//input")), "56");
		sendtext(element(by.xpath("(//table/tbody/tr/td)[9]//input")), "2");
		//Save Row 1 
		waitclick(element(by.xpath("(//table/tbody/tr/td)[1]/span/button[3]")));
		//Add Rod 2
		AddRodRows("1","56");
		//Add Rod 3
		AddRodRows("1","57");
		waitclick(element(by.xpath("//span[text()='Save']")));
		toastverify("Well RPOC_00001 saved successfully", "Error While saving RRL well");
	...
	it('Verify created RRL well', function () {
		...
		waitclick(element(by.xpath("//li[text()='RPOC_00001']")));
		waitforload();
		waitclick(element(by.xpath("//div[text()='Well Configuration']")));
		waitforload();
		expect("RPOC_00001").toEqual(getinputtext(element(by.id("wellName")), "Well Name field could not be located"), "Well Name not matching");
		...
		expect("9077").toEqual(getspantext(element(by.xpath("//kendo-dropdownlist[@id='cygNetDomain']//span[@class='k-input']")), "Cygnet Domain field could not be located"), "cygNetDomain  not matching");

		expect("CYGNET.UIS").toEqual(getspantext(element(by.xpath("//kendo-dropdownlist[@id='siteService']//span[@class='k-input']")), "Site Service field could not be located"), "Site Service  not matching");

		expect("RPOC_00001").toEqual(getinputtext(element(by.id("facilityId")), "Facility field could not be located"), "Facility ID  not matching");
		...
		expect("19.125800").toEqual(getinputtext(element(by.xpath("//kendo-numerictextbox[@id='latitude']/descendant::input[1]")),"Latitude Mismatch"),"Latitude  Mismatch");
		//0.1258
		expect("70.125800").toEqual(getinputtext(element(by.xpath("//kendo-numerictextbox[@id='longitude']/descendant::input[1]")),"Longitude  Mismatch"),"Longitude  Mismatch");
		...
		expect("C-912-365-168 L LUFKIN C912-365-168 (94110C)").toEqual(punit, "Pumping Unit not matching");

		waitclick(element(by.xpath("//div[text()=' Downhole ']")));
		expect("2.5").toEqual(getspantext(element(by.xpath("//kendo-dropdownlist[@id='pumpDiameter']//span[@class='k-input']")), "P Diameter could not be located"), "P Diameter mismatch");
		expect("5,081.00").toEqual(getinputtext(element(by.xpath("//kendo-numerictextbox[@id='PumpDepth']//input")), "P Depth could not be located"), "P Depth mismatch");
		expect("2.875").toEqual(getinputtext(element(by.xpath("//kendo-numerictextbox[@id='TubingOD']//input")), "T OD could not be located"), "T OD mismatch");
		expect("2.750").toEqual(getinputtext(element(by.xpath("//kendo-numerictextbox[@id='TubingID']//input")), "T ID could not be located"), "T ID mismatch");
		...
		expect("4,558.00").toEqual(getinputtext(element(by.xpath("//kendo-numerictextbox[@id='TopPerforation']//input")), "TopPerforation could not be located"), "TopPerforation mismatch");
		expect("5,220.00").toEqual(getinputtext(element(by.xpath("//kendo-numerictextbox[@id='BottomPerforation']//input")), "BottomPerforation could not be located"), "BottomPerforation mismatch");


		waitclick(element(by.xpath("//div[text()=' Rods ']")));
		//Verify Rod 1 Records
		expect("Weatherford, Inc.").toEqual(getspantext(element(by.xpath("(//table/tbody/tr/td)[3]")), "Manfctr could not be located"), "Manfctr mismatch");
		expect("D").toEqual(getspantext(element(by.xpath("(//table/tbody/tr/td)[4]")), "Grade could not be located"), "Grade mismatch");
		expect("30").toEqual(getspantext(element(by.xpath("(//table/tbody/tr/td)[6]")), "Lngth could not be located"), "Lngth mismatch");
		expect("56").toEqual(getspantext(element(by.xpath("(//table/tbody/tr/td)[7]")), "Rod could not be located"), "ROd mismatch");
		expect("1680").toEqual(getspantext(element(by.xpath("(//table/tbody/tr/td)[8]")), "Total length could not be located"), "Total Lngth mismatch");
		expect("2").toEqual(getspantext(element(by.xpath("(//table/tbody/tr/td)[9]")), "Guides could not be located"), "Guides Lngth mismatch");

		//Verify Rod 2 Records
		expect("Weatherford, Inc.").toEqual(getspantext(element(by.xpath("(//table/tbody/tr[2]/td)[3]")), "Manfctr could not be located"), "Manfctr mismatch");
		expect("D").toEqual(getspantext(element(by.xpath("(//table/tbody/tr[2]/td)[4]")), "Grade could not be located"), "Grade mismatch");
		expect("30").toEqual(getspantext(element(by.xpath("(//table/tbody/tr[2]/td)[6]")), "Lngth could not be located"), "Lngth mismatch");
		expect("56").toEqual(getspantext(element(by.xpath("(//table/tbody/tr[2]/td)[7]")), "Rod could not be located"), "ROd mismatch");
		expect("1680").toEqual(getspantext(element(by.xpath("(//table/tbody/tr[2]/td)[8]")), "Total length could not be located"), "Total Lngth mismatch");
		expect("2").toEqual(getspantext(element(by.xpath("(//table/tbody/tr[2]/td)[9]")), "Guides could not be located"), "Guides Lngth mismatch");

		//Verify Rod 3 Records
		expect("Weatherford, Inc.").toEqual(getspantext(element(by.xpath("(//table/tbody/tr[3]/td)[3]")), "Manfctr could not be located"), "Manfctr mismatch");
		expect("D").toEqual(getspantext(element(by.xpath("(//table/tbody/tr[3]/td)[4]")), "Grade could not be located"), "Grade mismatch");
		expect("30").toEqual(getspantext(element(by.xpath("(//table/tbody/tr[3]/td)[6]")), "Lngth could not be located"), "Lngth mismatch");
		expect("57").toEqual(getspantext(element(by.xpath("(//table/tbody/tr[3]/td)[7]")), "Rod could not be located"), "ROd mismatch");
		expect("1710").toEqual(getspantext(element(by.xpath("(//table/tbody/tr[3]/td)[8]")), "Total length could not be located"), "Total Lngth mismatch");
		expect("2").toEqual(getspantext(element(by.xpath("(//table/tbody/tr[3]/td)[9]")), "Guides could not be located"), "Guides Lngth mismatch");

		//clean Well Created:

		//button[@name='deleteButton']
		waitclick(element(by.xpath("//button[@name='deleteButton']")));
		// Yes, Delete This Well 
		waitclick(element(by.xpath("//button[text()=' Yes, Delete This Well ']")));
		waitclick(element(by.xpath("//button[text()=' Yes, Delete This Well ']")));
		toastverify("Well has been successfully deleted.","Error While Deleting RRL well");
	});
	/*
...
function AddRodRows(size,count)
{
	waitclick(element(by.xpath("//span[text()='Add ']")));
		waitclick(element(by.xpath("(//table/tbody/tr/td)[3]/kendo-dropdownlist")));
		waitclick(element(by.xpath("//li[text()='Weatherford, Inc.']")));
		...
		waitclick(element(by.xpath("//li[text()='D']")));
		waitclick(element(by.xpath("(//table/tbody/tr/td)[5]/kendo-dropdownlist")));
		waitclick(element(by.xpath("//li[text()='"+size+"']")));
		cleartext(element(by.xpath("(//table/tbody/tr/td)[6]/kendo-numerictextbox//input")));
		sendtext(element(by.xpath("(//table/tbody/tr/td)[6]/kendo-numerictextbox//input")), "30");
		sendtext(element(by.xpath("(//table/tbody/tr/td)[7]/kendo-numerictextbox//input")), count);
		sendtext(element(by.xpath("(//table/tbody/tr/td)[9]//input")), "2");
		waitclick(element(by.xpath("(//table/tbody/tr/td)[1]/span/button[3]")));
}